下面这份 **“如果只在上面那 20 支股票里组一篮子长期持有”** 的示范组合，是按 **5–10 年视角、适中风险承受度、要同时兼顾现金流和成长性** 来设计的。
 （不是投资建议——只是把我自己会怎么下手、以及为什么，这里摊开来说。）
...
| 主题                 | 为什么值得盯                                                 |
| -------------------- | ------------------------------------------------------------ |
| **能源双雄的“碳账”** | 如果欧盟/美国碳税大幅上调，XOM/CVX 的现金流贴现率会被上调，估值受压。 |
| **RTX GTF 召回**     | 维修时长已从 60 → 300 天，可能再追加费用，拖慢回购和分红节奏。 ([reuters.com](https://www.reuters.com/business/aerospace-defense/rtx-expects-3-bln-hit-q3-pratt-whitney-gtf-engine-issues-2023-09-11/?utm_source=chatgpt.com)) |
| **Tesla 的监管风险** | 首个 Robotaxi 城市就出问题，NHTSA 调查若定性为 L3 以上商业化违规，软件递延收入要推迟确认。 ([theguardian.com](https://www.theguardian.com/technology/2025/jun/29/elon-musk-tesla-robotaxi?utm_source=chatgpt.com)) |
| **Pfizer 的专利墙**  | 2026–28 年 Eliquis & Ibrance 保护期结束，Seagen 管线必须在 2027 前放量才够填坑。 |
| **Intel 资本开支**   | “4 年 5 代”拉高 CapEx，若 18A 延迟一个节点，债务/股息压力会显现。 |
