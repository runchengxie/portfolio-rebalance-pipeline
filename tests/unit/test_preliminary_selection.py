...
class TestRollingWindowLogic:
    ...
    def test_rolling_window_consistency(self):
        ...
        dates = [base_date + relativedelta(months=3*i) for i in range(20)]  # 5年季度数据
    ...
    def test_min_reports_threshold(self):
        ...
        df = pd.DataFrame({
            ...
            'date_known': pd.to_datetime([
                '2022-01-01', '2022-04-01', '2022-07-01',  # AAPL
                '2021-01-01', '2021-04-01', '2021-07-01', '2021-10-01',
                '2022-01-01', '2022-04-01', '2022-07-01', '2022-10-01'  # MSFT
            ]),
...
class TestTopNSelection:
    ...
    def test_tie_break_by_ticker(self):
        ...
        df = pd.DataFrame({
            ...
            'num_reports': [10, 10, 8]
        }, index=['MSFT', 'AAPL', 'GOOGL'])  # 故意打乱顺序
        
        # 按分数降序，然后按ticker升序排序（稳定的tie-break）
        sorted_df = df.sort_values(
            by=['avg_factor_score', df.index], 
