...
def run_backtest(
    ...
    final_value = (
        initial_cash * cumulative_returns.iloc[-1]
    ...
    portfolio_value.plot(
        ax=ax, label="Quarterly Multi-Factor Strategy", color="royalblue", lw=2
    )

    ax.set_title(
        f"Quarterly Strategy Backtest Performance ({start_date.year} - {end_date.year})",
        fontsize=16,
    )
